...
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_2stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_2stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_2stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_3stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_3stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_3stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_4stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_4stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_4stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_5stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_5stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_5stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_6stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_6stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_6stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_7stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_7stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_7stage_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_2stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_2stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_2stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_3stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_3stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_3stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_4stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_4stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_4stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_5stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_5stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_5stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_6stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_6stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_6stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_7stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_7stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_7stage_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_2stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_2stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_2stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_3stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_3stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_3stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_4stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_4stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_4stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_5stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_5stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_5stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_6stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_6stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_6stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_7stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_7stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_7stage_from_odd_to_even
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_2stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_2stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_2stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_3stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_3stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_3stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_4stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_4stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_4stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_5stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_5stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_5stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_6stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_6stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_6stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/ra_fw_en_7stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rb_fw_en_7stage_from_even_to_odd
add wave -noupdate -group RF -group forwarding_signal /tb_top_level/dut/RFFU_inst/rc_fw_en_7stage_from_even_to_odd
...
add wave -noupdate -group RF /tb_top_level/dut/RFFU_inst/RF_inst/reg_file
...
add wave -noupdate -group LSmem /tb_top_level/dut/Odd_Pipe_inst/LSmem_inst/LS_addr
...
add wave -noupdate -group LSmem /tb_top_level/dut/Odd_Pipe_inst/LSmem_inst/LS_mem
...
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/clk
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IF_inst/instruction_out1
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IF_inst/instruction_out2
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/instr_id_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/reg_dst_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/unit_id_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/latency_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/reg_wr_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme7_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme10_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme16_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme18_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/ra_addr_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/rb_addr_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/rc_addr_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/instr_id_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/reg_dst_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/unit_id_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/latency_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/reg_wr_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme7_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme10_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme16_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/imme18_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/ra_addr_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/rb_addr_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/IDHU_inst/rc_addr_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/ra_data_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/rb_data_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/rc_data_even
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/ra_data_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/rb_data_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/rc_data_odd
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/reg_write_en_1
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/reg_write_en_2
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/reg_write_addr_1
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/reg_write_addr_2
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/reg_write_data_1
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/reg_write_data_2
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/RFFU_inst/RF_inst/reg_file
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_1stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_2stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_3stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_4stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_5stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_6stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Even_Pipe_inst/packed_7stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Odd_Pipe_inst/packed_1stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Odd_Pipe_inst/packed_2stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Odd_Pipe_inst/packed_3stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Odd_Pipe_inst/packed_4stage
add wave -noupdate -expand -group Full_pipe_demo /tb_top_level/dut/Odd_Pipe_inst/packed_5stage
